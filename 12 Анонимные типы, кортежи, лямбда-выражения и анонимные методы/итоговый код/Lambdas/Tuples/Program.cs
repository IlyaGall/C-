...
namespace Tuples
{
    internal class Program
    {
        ...
        public static (bool, string, string) TryParseBool(string str)
        {
            str = str.ToLower();
            if (str == "ложь")
            {
        ...
        private static void Main(string[] args)
        {
            ...
            (TestClass, string, int) tuple = (new TestClass(), "", 100);

            List<(TestClass, string, int)> tuplesList = new List<(TestClass, string, int)>();
