...
namespace HomeWork13_3
{
    /*
        ...
        Надо создать экземпляры этих классов, а затем последовательно вызвать каждый из методов AddPart, передавай в него результат вызова предыдущего метода,
    ...
    internal class Program
    {
        ...
        {
            var part1 = new Part1(ImmutableList<string>.Empty.AddRange(new[] { "" }));
            var part2 = new Part2(part1.AddPart(part1.Poem));
            var part3 = new Part2(part2.AddPart(part2.Poem));
            ...
            foreach (var part in part9.AddPart(part9.Poem))
            {
