...
Кодировка, содержаûая поити все символы мирового алфавита
...
Символы же в диапазоне 1000016..10FFFF16 (больше 16 бит) кодируются по следуюûей схеме:
* Из кода символа выиитается 1000016. В результате полуиится знаиение от нуля до FFFFF16, 
которое помеûается в разрядную сетку 20 бит.
