...
Стандарт кодированиā двоиùнýх даннýх при помоûи 64символа 
алфавита ИсполþзуĀтсā
• 0-9 (10 символов)
• A-Z, a-z (52 символа)
• 2 символа в зависимости от реализаøии
Рассмотрим реализаøиĀ MIME (исполþзуетсā в ÿлектронной поùте)
• Исполþзуем дополнителþно ‘+’ и ‘/’ и добиваем длā кратности 3 символом 
‘=‘
